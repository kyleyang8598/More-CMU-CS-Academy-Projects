...
# Stickman
stickman = Group(Circle(200,235,10,fill='white',border='brown'),
                Line(200,245,200,265,fill='brown'),
                Line(190,255,210,255,fill='brown'),
                Line(200,265,190,275,fill='brown'),
                Line(200,265,210,275,fill='brown'))
